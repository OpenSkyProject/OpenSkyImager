...
int  qhy10_setregisters(qhy_exposure *expar) 
{
	...
	{
		case 1: 
			i_width = 2816; height = 991*4; Vbin = bin; Hbin = bin; width = i_width; top_skip_pix = 1190;
			break;
		case 2: 
			i_width = 2816; height = 991*2; Vbin = bin; Hbin = 1; width = i_width / 2; top_skip_pix = 1190;
			break;
		case 4: 
			i_width = 2816; height = 991;   Vbin = bin; Hbin = 1; width = i_width / 4; top_skip_pix = 1190;
			break;
		default:
	...
	if (expar->height > 0 && expar->height < 991)
	{
		// Try set camera special mode for focus purpouse (several overrides)
		i_width = 2816; height = 991; width = i_width / 4; bin=3; Hbin = 1; Vbin = 99; top_skip_pix = 0;
		top_skip_null = 25;

...
extern "C"
{
	...
	CameraDescriptionType Cams[16] =
	{
		...
		{0x4, 4, 510, 6, 10, 6, 765, 13, 900, 900, 1, "KAF040x", "ST7"},
		{0x5, 6, 1020, 6, 10, 6, 1530, 16, 900, 900, 1, "KAF160x", "ST8"},
		...
		{0xa, 8, 504, 8, 4, 8, 504, 12, 2000, 2000, 1, "KAF0261", "ST9"},
		{0x8, 3, 496, 1, 4, 23, 658, 0, 740, 740, 0, "TC-237B", "STv"},
		{0xc, 34, 1472, 0, 12, 36, 2178, 38, 680, 680, 1, "KAF320x", "ST10"},
		{0xd, 12, 1008, 12, 4, 12, 1008, 12, 2400, 2400, 0, "KAF1001", "ST1001"},
